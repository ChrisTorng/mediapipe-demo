...
var outputDir = path.resolve(__dirname, "../../public/mediapipe");
var assets = [
    {
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!response.ok || !response.body) {
                        throw new Error("\u4E0B\u8F09 ".concat(name, " \u5931\u6557\uFF1A").concat(response.status, " ").concat(response.statusText));
                    }
                    _b = (_a = Buffer).from;
                    return [4 /*yield*/, response.arrayBuffer()];
                case 2:
                    buffer = _b.apply(_a, [_c.sent()]);
                    return [4 /*yield*/, writeFile(path.join(outputDir, name), buffer)];
                case 3:
                    _c.sent();
                    return [2 /*return*/];
            }
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, assets_1, _a, name_1, url, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, mkdir(outputDir, { recursive: true })];
                case 1:
                    _b.sent();
                ...
                case 2:
                    ...
                    _a = assets_1[_i], name_1 = _a.name, url = _a.url;
                    process.stdout.write("Fetching ".concat(name_1, "... "));
                    _b.label = 3;
                case 3:
                    _b.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, downloadAsset(name_1, url)];
                case 4:
                    _b.sent();
